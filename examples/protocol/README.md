...
`src/demo.ts` imports only the generated TypeScript and the public SnapScript world API. It creates a host world and a client world, spawns a generated `Player`, sends a generated `Movement.Move` command, and handles a generated `Movement.MoveDisabled` event through the generated `rpc` helpers.
